...
Next. Q7. What should the teach-back checklist cover? Answer. Pipeline: capture → persist → upload → symbolicate. Async-signal-safe one-liner. crash free sessions definition + 99.95% / 30L context (BookMyShow I M O C + crash-free at scale). BookMyShow synchronised dictionaries contributes; does not solely cause crash free sessions. I M O C pillars. Hang gap vs crash free sessions. Next: signal safety and OOM honesty in sample 02. Follow-ups. dSYM keyword?: UUID match for readable stacks.. Breadcrumb keyword?: Last-N event trail — filled on happy path.. Next sample?: 02-signal-safety-oom.md.
