# Sample 07 — Revision Q&A (day-02) (Q&A)
...
### I1. A junior asks you in standup: “What is protocol-oriented programming?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | What is protocol-oriented programming |
...
### I2. Production symptom: something related to “associatedtype vs generic parameter” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | associatedtype vs generic parameter |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I3. Interviewer never names the topic. They describe a mess that maps to “some vs any”. How do you diagnose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | some vs any |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I4. Code review: you spot a smell around “Why generics in an ads pipeline”. What do you say and what fix do you propose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Why generics in an ads pipeline |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I5. What happens if a teammate ignores the rule behind “Protocol extension default methods — dispatch catch”? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Protocol extension default methods — dispatch catch |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I6. Walk me through a failed interview answer on “What is type erasure” and how you’d correct it? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | What is type erasure |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I7. A junior asks you in standup: “Protocol composition (A & B)?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Protocol composition (A & B) |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I8. Production symptom: something related to “When is inheritance still OK” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | When is inheritance still OK |
| How do you prove it? | Give a tiny example or production boundary. |
...
### T11. What prints? Why? `(90–120s)`
**Answer:**

> “Often "default". wave was never a requirement, so the call binds to the extension based on the static type any Greeter. Promote wave into the protocol body if polymorphic override matters. ---.”
...
### T12. Fragile base class ads hierarchy? `(90–120s)`
**Answer:**

> “Every subclass fights the shared base. New creatives fork the tree. Tests mock deep hierarchies. Prefer capability protocols — render / track / playback — so image tiles don’t inherit video APIs and the base doesn’t become a god object. ---.”
...
### T13. Always POP everything? `(90–120s)`
**Answer:**

> “Interviewer: “So you POP every feature on day one?” Good reply: “No. Two similar types forever — maybe don’t abstract yet. Highest-revenue growing creatives — abstraction pays. Introduce POP when variants or test seams demand it. At BookMyShow ads scale, variants justified the pipeline — I still don’t invent fill-rate percentages.” --- Next: 02-associated-types-erasure.md.”
...
### T14. Why `[AdRenderable]` fails with associated View? `(90–120s)`
**Answer:**

> “Image and video pick different ContentView types. The existential doesn’t know a single view shape. Stay generic, erase to a common surface (often UIView), use constrained any, or a closed enum. ---.”
