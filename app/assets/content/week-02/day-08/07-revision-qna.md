# Sample 07 — Revision Q&A (day-08) (Q&A)
...
### I1. A junior asks you in standup: “Explain MVVM vs MVC.?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Explain MVVM vs MVC. |
...
### I2. Production symptom: something related to “When do you introduce Clean Architecture” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | When do you introduce Clean Architecture |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I3. Interviewer never names the topic. They describe a mess that maps to “What is MVI / unidirectional data flow”. How do you diagnose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | What is MVI / unidirectional data flow |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I4. Code review: you spot a smell around “How do you do DI on iOS without a container”. What do you say and what fix do you propose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | How do you do DI on iOS without a container |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I5. What happens if a teammate ignores the rule behind “How would you structure BMS search in MVVM”? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | How would you structure BMS search in MVVM |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I6. Walk me through a failed interview answer on “Fat ViewModel — smells and fix” and how you’d correct it? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Fat ViewModel — smells and fix |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I7. A junior asks you in standup: “How do View and ViewModel communicate in UIKit vs SwiftUI?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | How do View and ViewModel communicate in UIKit vs SwiftUI |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I8. Production symptom: something related to “How did you use AI in the District migration without losing seniority” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | How did you use AI in the District migration without losing seniority |
| How do you prove it? | Give a tiny example or production boundary. |
