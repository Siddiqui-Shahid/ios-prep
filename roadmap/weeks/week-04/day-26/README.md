...
- Deliver **2–3 min** STARs with clock discipline (20s S/T → 90s Action → 30s Result → 20s Lesson)
- Ship **full spoken scripts** for **S8 / S6 / S9 / S1** (priority set)
- Handle conflict, incident, mentorship, and **AI tooling judgment without tool-worship**
- Map prompts → story IDs in ≤10s; metrics only: **30L+ DAU**, **99.95% crash-free**, **30%+ nav**
