...
| Follow-up | Answer |
|---|---|
| Proctor fills scorecard? | Yes — candidate reflects aloud; proctor scores. |
...
| Follow-up | Answer |
|---|---|
| “Just one more Medium”? | Forbidden — fatigue hurts real interviews. |
...
| Follow-up | Answer |
|---|---|
| “That seems high”? | Explain measurement window and flow scope. |
...
| Follow-up | Answer |
|---|---|
| Partial code enough? | Often yes with clear optimal plan — scorecard **3**. |
