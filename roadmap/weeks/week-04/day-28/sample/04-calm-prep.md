...
| Follow-up | Answer |
|---|---|
| Third time today? | Once in checklist block is enough — no loop. |
...
| Follow-up | Answer |
|---|---|
| Add example pattern? | Optional one word — “hash” or “heap” — not a new problem. |
...
| Follow-up | Answer |
|---|---|
| Name tools? | Only if asked — context engineering matters more. |
...
| Follow-up | Answer |
|---|---|
| “Just one LC”? | Violates taper — park it. |
...
| Follow-up | Answer |
|---|---|
| X is whole SD topic? | Nearest system + four-layer sketch — honest assume. |
...
| Follow-up | Answer |
|---|---|
| Say aloud or silent? | Once aloud — confidence cue. |
