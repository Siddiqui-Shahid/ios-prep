...
| Set | Items | Focus |
|---|---|---|
| A | Q4, Q2, T3, T4 | SafeDict + sync/async + re-entry + barrier autopsy |
| B | Q1, Q7, T1, T2 | Queues + barrier + visibility + hide API |
| C | Full BookMyShow synchronised dictionaries STAR + T6 + Design: actor SafeDict (not shipped) 90s | Provenance honesty |
| Brain-puzzle sprint | T1, T3, T5, T7, T10 | Visibility, deadlock, group.wait, async bridge, honesty |
