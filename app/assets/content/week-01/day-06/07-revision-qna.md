# Sample 07 — Revision Q&A (day-06) (Q&A)
...
### I1. A junior asks you in standup: “Explain two pointers?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Explain two pointers |
...
### I2. Production symptom: something related to “Sliding window vs two pointers” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Sliding window vs two pointers |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I3. Interviewer never names the topic. They describe a mess that maps to “When prefix sums”. How do you diagnose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | When prefix sums |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I4. Code review: you spot a smell around “Why narrate before coding”. What do you say and what fix do you propose? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Why narrate before coding |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I5. What happens if a teammate ignores the rule behind “Two Sum — approach”? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Two Sum — approach |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I6. Walk me through a failed interview answer on “Buy/Sell Stock — approach” and how you’d correct it? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Buy/Sell Stock — approach |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I7. A junior asks you in standup: “Valid Palindrome — approach?” — how do you answer without jargon? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Valid Palindrome — approach |
| How do you prove it? | Give a tiny example or production boundary. |
...
### I8. Production symptom: something related to “Container With Most Water — approach” just broke under load. What do you check first? `(60–90s)`
**Answer:**
...
| Follow-up | Answer |
|---|---|
| What concept is this really? | Container With Most Water — approach |
| How do you prove it? | Give a tiny example or production boundary. |
