...
**Points to:** [Deep dive · §6 HeroWidget video](../02-deep-dive.md#6-herowidget-video-s1-deep) · [Foundations · §6 Two production media stories](../01-foundations.md#6-two-production-media-stories-preview)
...
**Points to:** [Deep dive · §6 HeroWidget video](../02-deep-dive.md#6-herowidget-video-s1-deep)
...
**Points to:** [Deep dive · §7 Aces audio + splash](../02-deep-dive.md#7-aces-audio--splash-s12-deep) · [Foundations · §2 Glossary](../01-foundations.md#2-glossary)
...
**Points to:** [Deep dive · §7 Aces audio + splash](../02-deep-dive.md#7-aces-audio--splash-s12-deep) · [Foundations · §2 TTI](../01-foundations.md#2-glossary)

**Answer:**

> Splash content from server for freshness/flexibility — measure **time-to-interactive (TTI)**, not vanity first-frame alone. Cache last-good splash if network is slow. **Do not invent ms numbers** in interviews — speak categories: product surface, TTI mindset, fail-soft if payload bad (S3 soft).
...
**Points to:** [Deep dive · §5 Memory pressure](../02-deep-dive.md#5-memory-pressure-playbook) · [Deep dive · §9 Trade-offs](../02-deep-dive.md#9-trade-offs)
...
**Points to:** [Deep dive · §9 Trade-offs](../02-deep-dive.md#9-trade-offs)
...
**Points to:** [Foundations · §6 Two production media stories](../01-foundations.md#6-two-production-media-stories-preview) · [Production bridge · §1](../03-production-bridge.md#1-provenance-map)

**Answer:**

> **S1 Verified:** HeroWidget pause/play on highest-revenue Ads — POP+Generics pipeline. **S12 Verified:** Live audio + server-driven splash on Aces — TTI mindset, no invented ms. **S10 soft:** Inject image loader into Stories. Next sample covers STAR language for S1/S12.

**Follow-ups:**

| Follow-up | Answer |
|---|---|
| S1 forbidden claim? | Invented fill-rate % or “I wrote Kingfisher.” |
| S12 forbidden claim? | Invented splash latency ms. |
